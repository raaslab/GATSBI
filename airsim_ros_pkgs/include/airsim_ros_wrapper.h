...
private:
    ...
    sensor_msgs::PointCloud2 get_lidar_segmentation_from_airsim(const msr::airlib::LidarData& lidar_data, const std::string& vehicle_name) const;
...
private:
    ...
    ros::Publisher segmented_publisher, segmented_publisher_2;
