...
#navigator_client = actionlib.SimpleActionClient('airsim_navigator', airsim_moveit_navigation.msg.AirSim_NavigationAction)
...
total_flight_rrt_distance = 0
total_flight_rrt_distance_2 = 0
...
initial_data = np.array([[0, 0, 0, 0, 0, 0, 0, 0]])
...
def listener():
    ...
    while True:
        ...
        global total_flight_rrt_distance
        global total_flight_rrt_distance_2
        ...
        global initial_data
        current_data = np.array([[rospy.get_rostime().secs - start_time, (total_flight_distance + total_flight_distance_2), total_observed, total_flight_distance, total_flight_distance_2, (total_flight_rrt_distance + total_flight_rrt_distance_2), total_flight_rrt_distance, total_flight_rrt_distance_2]])
        ...
        for i in range(start_index, max_traj):
            if i == start_index:
                initial_point_1[0] = rrt_poses_drone_1[0][0]
                initial_point_1[1] = rrt_poses_drone_1[0][1]
                initial_point_1[2] = rrt_poses_drone_1[0][2]

                initial_point_2[0] = rrt_poses_drone_2[0][0]
                initial_point_2[1] = rrt_poses_drone_2[0][1]
                initial_point_2[2] = rrt_poses_drone_2[0][2]
            ...
            if i < rrt_poses_drone_1.shape[0]:
                next_point_1[0] = rrt_poses_drone_1[i][0]
                next_point_1[1] = rrt_poses_drone_1[i][1]
                next_point_1[2] = rrt_poses_drone_1[i][2]
                ...
                total_flight_rrt_distance += distance

            if i < rrt_poses_drone_2.shape[0]:
                next_point_2[0] = rrt_poses_drone_2[i][0]
                next_point_2[1] = rrt_poses_drone_2[i][1]
                next_point_2[2] = rrt_poses_drone_2[i][2]
                ...
                total_flight_rrt_distance_2 += distance

        final_index = rrt_poses_drone_1.shape[0] - 1
        rospy.loginfo("Drone 1 Traj Step[1]: [%.2f, %.2f, %.2f]", rrt_poses_drone_1[final_index][0], rrt_poses_drone_1[final_index][1], rrt_poses_drone_1[final_index][2])
        ...
        rospy.loginfo("Drone 2 Traj Step[1]: [%.2f, %.2f, %.2f]", rrt_poses_drone_2[final_index][0], rrt_poses_drone_2[final_index][1], rrt_poses_drone_2[final_index][2])
